...
pub static mut GDT: GlobalDescriptorTable = {
    ...
    GlobalDescriptorTable { entries: [zero, kernel_code, kernel_data, user_code, user_data, tss_entry] }
};
...
impl GlobalDescriptorTable {
    pub fn load(&self) {
        ...
        unsafe { asm!("lgdt [{0:e}]", in(reg) &gdt_descriptor); }
    }
    ...
    pub fn write_tss(&mut self) -> u16 {
        ...
        let tss_base = unsafe { &crate::tss::TSS as *const _ as u32 };
        ...
        unsafe { &crate::tss::TSS as *const _ as u16 }
    }
}